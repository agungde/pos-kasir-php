								...
								<div class="panel-body">
									...
									<div id="kasirnya">
										<table class="table table-stripped">
												...
												if(!empty($bayar))
												{
													...
													if($bayar >= $total)
													{
														...
														for($x=0;$x<$jumlah_dipilih;$x++){
															...
															$d = array($id_barang[$x],$id_member[$x],$jumlah[$x],$total[$x],$tgl_input[$x],$periode[$x],$harga_beli[$x]);
															$sql = "INSERT INTO notabeli (id_barang, id_member,jumlah,total,tanggal_input,periode,harga_beli) VALUES(?,?,?,?,?,?,?)";
											...
											?>
											<!-- aksi ke table nota -->
											<form method="POST" action="index.php?page=beli&notabeli=yes#kasirnya">
												<?php foreach($hasil_pembelian as $isi){;?>
													<input type="hidden" name="id_barang[]" value="<?php echo $isi['id_barang'];?>">
													<input type="hidden" name="id_member[]" value="<?php echo $isi['id_member'];?>">
													<input type="hidden" name="jumlah[]" value="<?php echo $isi['jumlah'];?>">
													<input type="hidden" name="harga_beli[]" value="<?php echo $isi['harga_beli'];?>">
												...
												<tr>
													...
													<?php  if(!empty($_GET['notabeli'] == 'yes')) {?>
											...
											<!-- aksi ke table nota -->
												...
												<td>
													<a href="printbeli.php?nm_member=<?php echo $_SESSION['admin']['nm_member'];?>
