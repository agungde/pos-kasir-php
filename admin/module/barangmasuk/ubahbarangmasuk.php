            ...
            <div class="card-body">
              <div class="table-responsive">
						...
						<label for="">Jenis Barang</label>
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                  <input type="text" name="harga_beli" class="form-control" id="harga_beli" value="<?php echo $tampil['harga_beli']; ?>"/>	 
							</div>
                            </div>
                            ...
                            <div class="form-group">
                               <div class="form-line">
                                  <input type="text" name="harga_jual" class="form-control" id="harga_jual" value="<?php echo $tampil['harga_jual']; ?>"/>	 
							</div>
                            </div>
							...
							<?php
								...
								$sql = $koneksi->query("update gudang set kode_barang='$kode_barang',tanggal='$tanggal', nama_barang='$nama_barang', jenis_barang='$jenis_barang', satuan='$satuan' where kode_barang='$kode_barang'"); 
