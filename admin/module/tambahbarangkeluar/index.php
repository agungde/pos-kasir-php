          ...
          <section class="wrapper">
              ...
              <div class="row">
                  <div class="col-lg-12 main-chart">
					  	<a href="index.php?page=barangkeluar"><button class="btn btn-primary"><i class="fa fa-angle-left"></i> Balik </button></a>
						...
						<table class="table table-striped">
							<form action="fungsi/edit/edit.php?barang=edit" method="POST">
								<tr>
									<td>ID Barang</td>
									<td><input type="text" text="text" class="form-control" value="<?php echo $hasil['id_barang'];?>" name="id"></td>
								</tr>
								<tr>
									<td>Kategori</td>
									<td>
								...
								<tr>
									...
									<td>Jumlah</td>
									<td><input type="number" class="form-control" value="<?php echo $hasil['jumlah'];?>" name="jumlah"></td>
								</tr>
								<tr>
