              ...
              <div class="table-responsive">
                            ...
                            <div class="form-group">
                               <div class="form-line">
								...
								$sql = $koneksi -> query("select * from barang order by id_barang");
								while ($data=$sql->fetch_assoc()) {
									echo "<option value='$data[id_barang].$data[nama_barang]'>$data[kode_barang] | $data[nama_barang]</option>";
								}
								?>
                            ...
                            <div class="form-group">
                               <div class="form-line">
								...
								<?php
								$sql = $koneksi -> query("select * from satuan order by nama_satuan");
								while ($data=$sql->fetch_assoc()) {
									echo "<option value='$data[id].$data[satuan]'>$data[nama_satuan]</option>";
								}
								?>
								</select>
                            ...
                            <div class="form-group">
                               <div class="form-line">
                               <input text="text" name="harga-beli" id="harga-beli" type="number" class="form-control">
                            ...
                            <div class="form-group">
                               <div class="form-line">
                               <input text="text" name="harga_jual" id="harga_jual" type="number" class="form-control">
                            ...
                            <div class="form-group">
                               <div class="form-line">
								...
								$sql = $koneksi -> query("select * from supplier order by nama_supplier");
								while ($data=$sql->fetch_assoc()) {
							...
							if (isset($_POST['simpan'])) {
								...
								$sql = $koneksi -> query("select * from nota order by jumlah");
								
							
								
								$sql = $koneksi->query("insert into barang_masuk (id_transaksi, tanggal, kode_barang, nama_barang, jumlah, satuan, pengirim,hpp,totalhpp) values('$id_transaksi','$tanggal','$kode_barang','$nama_barang','$jumlah','$satuan','$pengirim','$hpp','$total_hpp')");
